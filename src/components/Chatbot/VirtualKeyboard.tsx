        ...
        >
          ...
          <div className="virtual-keyboard-actions">
            ...
            >
              ...
              {/* Translate Button */}
              {currentLanguage !== 'en' && typedText.trim() && (
                <motion.button
                  className="virtual-keyboard-action-btn translate-btn"
                  onClick={() => translateText(typedText, currentLanguage, 'en')}
                  whileHover={{ scale: 1.1, y: -2 }}
                  whileTap={{ scale: 0.9 }}
                ...
                >
                  <motion.div
                    animate={isTranslating ? { rotate: 360 } : {}}
              ...
              {/* Copy Button */}
              <motion.button
                className="virtual-keyboard-action-btn copy-btn"
                onClick={handleCopy}
                whileHover={{ scale: 1.1, y: -2 }}
                whileTap={{ scale: 0.9 }}
                title="Copy"
